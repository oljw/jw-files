 ...
 */
    ...
    public void changeFragment(String json, AppManagerConst.TransactionDir dir, FragmentChangeCause cause, boolean runningCommand) {
        ...
        try {
            ...
            // set arguments model in order to send more information of previous fragment to next fragment.
            ArgumentsModel argsModel = getArgsModel(mFragmentModel);
            if (argsModel == null)
                argsModel = new ArgumentsModel(json, dir.name());
            else {
                argsModel.setFragmentJson(json);
                argsModel.setTransitionDir(dir.name());
            }


            Bundle args = new Bundle();
            args.putSerializable(AppManagerConst.ARGUMENTS_MODEL, argsModel);
    ...
    public abstract ArgumentsModel getArgsModel(FragmentModel prevModel);
