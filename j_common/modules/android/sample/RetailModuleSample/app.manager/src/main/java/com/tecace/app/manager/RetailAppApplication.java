 ...
 */
public class RetailAppApplication extends RetailApplication {
    ...
    protected void setAppInfo(String pkg, String cls, String title, boolean selfFinish,
                              String analyticsAppId, String analyticsCognitoId) {
        setAppInfo(pkg, cls, title, selfFinish);

        //init Analyst
        initAnalytics(analyticsAppId, analyticsCognitoId);
    }
