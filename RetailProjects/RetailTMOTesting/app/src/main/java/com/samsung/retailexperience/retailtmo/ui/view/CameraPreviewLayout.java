package com.samsung.retailexperience.retailtmo.ui.view;
...
//        }
    ...
    private void drawFocusIcon(final float x, final float y) {
        ...
        MarginLayoutParams marginLayoutParams =
                (MarginLayoutParams) mFocusIcon.getLayoutParams();
                        ...
                        mTextureView.setOnTouchListener(new OnTouchListener() {
                            ...
                            public boolean onTouch(View v, MotionEvent event) {
                                ...
                                if (event.getAction() == MotionEvent.ACTION_UP && mTextureView != null) {
                                    ...
                                    mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AWB_REGIONS, focusArea);
...
//            }
     ...
     */
    public void openCamera(String cameraIdNum) {
