...
public class B2B_DisplayFragment extends BaseVideoFragment implements View.OnClickListener,
    ...
    public static final int DURATION_UNDETERMINED = -1;
    ...
    private static final float TAP_IMAGE_IMAGE_LIST_MARGIN_TOP = 324f;
    ...
    private void prepareZoomInableBitmap(String filePath) {
        ...
        mRetrieveBitmapForZoomIn.execute(filePathList);
    }
