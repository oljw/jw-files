...
//        }
    ...
    private void drawFocusIcon(final float x, final float y) {
        Log.d(TAG, "##### drawFocusIcon called");
     ...
     */
    private boolean areWeFocused = true;
                                ...
                                public boolean onTouch(View v, MotionEvent event) {
                                    switch (event.getAction()) {
                                        case MotionEvent.ACTION_DOWN:
                                            ...
                                            Log.i("onAreaTouchEvent","SENSOR_INFO_ACTIVE_ARRAY_SIZE,,,,,,,,rect.left--->" + rect.left +
                                            ...
                                            Log.i("onAreaTouchEvent","mCameraCharacteristics,,,,size.getWidth()--->" + size.getWidth() +
                                            ...
                                            Log.i("focus_position","focusLeft--->" + focusLeft + ",,,focusTop--->"+ focusBottom+
                                                    ",,,focusRight--->"+ (focusLeft + areaSize)+ ",,,focusBottom--->"
...
////                                            showToast("Manual Focus Activated");
//
...
//                                            focusArea[0] = new MeteringRectangle((int) event.getX(), (int) event.getY(), 100, 100, 0);
//
...
//
//                                            try {
//                                                mCaptureSession.capture(mPreviewRequestBuilder.build(), mPreCaptureCallback, null);
//                                            } catch (CameraAccessException e) {
//                                                e.printStackTrace();
//                                            }
////                                            configureManualFocus(mPreviewRequestBuilder);
//                                        }
//                                        return true;
//                                    }
//                                });
...
//                            areWeFocused = false;
//                        }
//                        Log.d(TAG, "#### areWeFocused: " + areWeFocused);
//                        break;
//                    }
...
////            view.findViewById(R.id.capture_btn).setOnClickListener(this);
...
//                        mRawImageReader.get().getSurface()),
        ...
        private void configureTransform(int viewWidth, int viewHeight) {
            synchronized (mCameraStateLock) {
                if (null == mTextureView || null == myActivity) {
                    return;
                }
                ...
                int deviceRotation = myActivity.getWindowManager().getDefaultDisplay().getRotation();
        ...
        private void takePicture() {
            ...
            synchronized (mCameraStateLock) {
                ...
                if (mState != STATE_PREVIEW) {
                    Log.d(TAG, "##### takePicture() TEST 2");

                    return;
                }

                try {
                    Log.d(TAG, "##### takePicture() TEST 3");

                    // Trigger an auto-focus run if camera is capable. If the camera is already focused,
                    // this should do nothing.
                    if (!mNoAFRun) {
                        Log.d(TAG, "##### takePicture() TEST 4");
        ...
        private void captureStillPictureLocked() {
            try {
                if (null == myActivity || null == mCameraDevice) {
                    return;
                }
...
//                captureBuilder.addTarget(mRawImageReader.get().getSurface());
                ...
                ImageSaver.ImageSaverBuilder jpegBuilder = new ImageSaver.ImageSaverBuilder(myActivity)
