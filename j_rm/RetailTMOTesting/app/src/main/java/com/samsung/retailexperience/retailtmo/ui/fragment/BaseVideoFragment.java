...
import com.samsung.retailexperience.retailtmo.gson.models.VideoModel;
...
import com.samsung.retailexperience.retailtmo.video.ui.view.CoreSuperTextView;
import com.samsung.retailexperience.retailtmo.video.ui.view.SuperTextView;
import com.samsung.retailexperience.retailtmo.video.ui.view.VideoTextureView;
...
public abstract class BaseVideoFragment extends BaseFragment implements
    ...
    private ArgumentsModel mArgumentsModel = null;
...
//                            if (mRotated == false) {
//                                mRotated = true;
//                                Analyst.getInstance().sendChapterActionEvent(AnalyticsInteractionActionType.ROTATE_DEVICE,
...
//
//                            if (mRotated == false) {
//                                Analyst.getInstance().sendChapterActionEvent(AnalyticsInteractionActionType.TIME_OUT,
//                                        AnalyticsInteractionActionType.Extra.ROTATE);
//                            }
//
//                            onPlayVideo();
...
//    }
    ...
    private void moveToEndPage() {
        ...
        changeFragment(getFragmentModel().getFragment().getAction(),
                AppConst.TransactionDir.TRANSACTION_DIR_FORWARD, FragmentChangeCause.VIDEO_COMPLETED);
    }
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            changeFragment(getFragmentModel().getFragment().getActionClick(),
                    AppConst.TransactionDir.TRANSACTION_DIR_FORWARD, FragmentChangeCause.TAP);
        }
    };
        ...
        if (skipBtn != null) {
            ...
            skipBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (getFragmentModel() == null || getFragmentModel().getFragment().getAction() == null) return;
                    changeFragment(getFragmentModel().getFragment().getAction(),
                            AppConst.TransactionDir.TRANSACTION_DIR_FORWARD, FragmentChangeCause.TESTING);
                }
            });
        }
