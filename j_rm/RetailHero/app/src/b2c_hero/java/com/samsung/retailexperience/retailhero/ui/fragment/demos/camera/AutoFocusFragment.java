...
public class AutoFocusFragment extends BaseCameraBackFragment
    ...
    //Preparing the Camera Preview so it doesn't take long time to open the camera preview
    ...
    //Super to tap the screen to manual focus
    ...
    //Capture super is visible and capture button is clickable.
    ...
    //Perform and take photo. Has shutter sound also.
    ...
    //Camera Preview is gone and output image is shown with "Your photo will not be saved" super.
