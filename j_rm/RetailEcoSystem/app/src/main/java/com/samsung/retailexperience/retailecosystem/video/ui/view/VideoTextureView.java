...
import com.samsung.retailexperience.retailecosystem.video.util.ChapterParseTask;
import com.samsung.retailexperience.retailecosystem.video.util.ChapterParseUtil;
    ...
    private void notifyChapterEnded() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (chapter != null && chapter.isStarted() && !chapter.isEnded()) {
                ...
                // Hack: Call ended() if start time is in future
