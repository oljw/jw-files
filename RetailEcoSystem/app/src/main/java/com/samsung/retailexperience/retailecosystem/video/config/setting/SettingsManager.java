package com.samsung.retailexperience.retailecosystem.video.config.setting;
...
public class SettingsManager implements ISettings {
    ...
    private static final String SHARED_PREFERENCE_NAME = "com.samsung.retailexperience.retailecosystem.default";
