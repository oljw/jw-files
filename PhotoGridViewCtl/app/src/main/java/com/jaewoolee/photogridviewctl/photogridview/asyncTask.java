...
public abstract class asyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        private final AtomicInteger mCount = new AtomicInteger(1);
            ...
            Log.d(LOG_TAG, "newThread(runnable r) executed");
     ...
     */
    public static final Executor SERIAL_EXECUTOR = com.jaewoolee.photogridviewctl.photogridview.utils.hasHoneycomb() ? new SerialExecutor() :
     ...
     */
    public asyncTask() {
        Log.d(LOG_TAG, "asyncTask() executed.. this looks important");
    ...
    private void postResultIfNotInvoked(Result result) {
        Log.d(LOG_TAG, "postResultIfNotInvoked executed... a boolean value? probably will be returned. or Result");
    ...
    private Result postResult(Result result) {
        Log.d(LOG_TAG, "postResult executed. ");
