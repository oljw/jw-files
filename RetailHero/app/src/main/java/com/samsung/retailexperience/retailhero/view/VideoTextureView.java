...
import com.samsung.retailexperience.retailhero.util.ChapterParseTask;
import com.samsung.retailexperience.retailhero.util.ChapterParseTask.ChapterParseListener;
import com.samsung.retailexperience.retailhero.util.ChapterParseUtil;
...
public class VideoTextureView extends FrameLayout implements
        SurfaceTextureListener, OnPreparedListener, ChapterParseListener, OnCompletionListener {
    ...
    public interface VideoBreakPointListener {
        void onVideoBreakPoint(VideoTextureView view, int nextChapter);
    }
    ...
    private String mPreVideoFrameFile;
            ...
            public void run() {
                if (mVideoBreakPointListener != null) {
                    mVideoBreakPointListener.onVideoBreakPoint(
                            VideoTextureView.this, mNextChapter);
                }
                mNextChapter++;
    ...
    public void preparePlayer() throws IllegalArgumentException,
        ...
        if (mSubtitleUri != null && mSubtitleMimeType != null) {
            ...
            int trackIndex = findTrackIndexFor(
                    TrackInfo.MEDIA_TRACK_TYPE_TIMEDTEXT, mPlayer.getTrackInfo());
