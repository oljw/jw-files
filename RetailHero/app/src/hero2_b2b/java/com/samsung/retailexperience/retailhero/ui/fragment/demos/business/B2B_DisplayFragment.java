...
public class B2B_DisplayFragment extends BaseVideoFragment implements View.OnClickListener,
    ...
    //private static final int NO_PHOTO_RESOURCE_ID = -1;
    ...
    private static final float TAP_IMAGE_CLICKABLE_AREA = TAP_IMAGE_SIZE + 2f;

    private View mTapAPhoto;
    private ImageView mZoomingInAnimation;
    private ImageView mZoomInableImageView;
    ...
    public void onViewCreated(View view) {
        ...
        mZoomInableImageView = (ImageView) view.findViewById(R.id.amoled_zoom_in_image);
