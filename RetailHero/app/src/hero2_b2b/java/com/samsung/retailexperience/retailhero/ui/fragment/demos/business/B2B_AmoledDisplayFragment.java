 ...
 */
public class B2B_AmoledDisplayFragment extends BaseVideoFragment {

    private static final String TAG = B2B_AmoledDisplayFragment.class.getSimpleName();

    public static B2B_AmoledDisplayFragment newInstance(FragmentModel<VideoModel> fragmentModel) {
        B2B_AmoledDisplayFragment fragment = new B2B_AmoledDisplayFragment();
